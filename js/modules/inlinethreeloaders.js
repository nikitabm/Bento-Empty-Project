 ...
 * @snippet InlineThreeLoaders|constructor
InlineThreeLoaders({})
 */
bento.define('modules/inlinethreeloaders', [
    'bento',
    'bento/utils'
], function (
    Bento,
    ...
    'use strict';
    var cache = {};
    var InlineGltfLoader = function (settings) {
        if (!THREE.GLTFLoader) {
        ...
        GLTFParser.prototype.loadBuffer = function (bufferIndex) {
            ...
            var assetsJson = Bento.assets.getAssetGroups();
            var comparison;
    ...
    var InlineFbxLoader = function (settings) {
        if (!THREE.FBXLoader) {
