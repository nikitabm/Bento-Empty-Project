        ...
        */
        var textID,
            ...
            init = function (textSettings) {
                ...
                // set up text
                if (textSettings.textID) {
                    textID = textSettings.textID;
                    textbox.setTextID(textID, maxWidth, maxHeight);
            ...
            textbox = new Entity({
                ...
                /**
                 * TODO: set strings by an id (useful for localization)
                 */
                setTextID: function (id, maxW, maxH) {
                    textID = id;
